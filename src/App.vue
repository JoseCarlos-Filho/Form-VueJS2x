	...
	<div id="app">
		...
		<div class="conteudo">
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Mensagem">
					<!-- a tag <pre></pre> preserva os espaços em branco e quebras de linha
					que são digitado na <textarea></textarea> podendo ser utilizado tambem
					em outras tags com <span></span> chamando a tag style e o atributo white-space 
					que recebe a  prorpiedade pre:(significado preserv) -->
